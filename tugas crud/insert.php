...
<form>
   ...
   <br>
    ...
    <div class="form-check">
         ...
         <label><input type="checkbox" name="olahraga[]" value="Renang">Renang </label><br>
         <label><input type="checkbox" name="olahraga[]" value="Tenis">Tenis</label><br>
         <label><input type="checkbox" name="olahraga[]" value="Bulu Tangkis">Bulu Tangkis</label><br>
    </div>
    ...
    <?php
        if (isset($_GET['submit'])){
            ...
            $foto = $_GET['foto'];        
            mysqli_query($kon," INSERT INTO `mahasiswa` (`nim`, `nama`, `jenis_kelamin`, `agama`, `olahraga`, `foto`) VALUES ('$nim','$nama','$jenis_kelamin','$agama','$olahraga','$foto')");
