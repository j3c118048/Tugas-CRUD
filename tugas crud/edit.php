...
<html lang="en">
  ...
  <body>
    ...
    <br>
    <div class="form-group">
      <label><input type="radio" name="jenis_kelamin" value="Laki - laki" <?php if($row['jenis_kelamin']=='Laki - laki') echo 'checked'?>>Laki - laki</label><br> 
   ...
   <br>
    ...
    <div class="form-check"> 
         ...
         <label><input type="checkbox" name="olahraga[]" value="Renang" 
         ...
         <label><input type="checkbox" name="olahraga[]" value="Bulu Tangkis" 
         <?php if (in_array("Bulu Tangkis", $dataor)) echo "checked";?>> Bulu Tangkis</label><br>
    </div>
